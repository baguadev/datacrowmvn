...
public class SoftpediaSearch extends SearchTask {
    ...
    protected DcObject getItem(URL url, boolean full) throws Exception {
        ...
        if (getMode() instanceof LinuxSearchMode)
            software.createReference(Software._H_PLATFORM, "Linux");
        ...
        if (node != null) {
            ...
            while (st.hasMoreElements()) {
                ...
                if (idx == mode.getIndex(SoftpediaSearchMode._DEVELOPER)) {
                   ...
                   dco.createReference(Software._F_DEVELOPER, StringUtils.trim(developer));
                    ...
                    while (categories.hasMoreElements()) {
                        dco.createReference(Software._K_CATEGORIES, StringUtils.trim((String) categories.nextElement()));
                    }
                    ...
                    dco.createReference(Software._Z_LICENSE, StringUtils.trim(license));
                    ...
                    if (license != null && StringUtils.trim(license).equalsIgnoreCase("free"))
                        dco.createReference(Software._Z_LICENSE, "Freeware");
                    ...
                    while (genres.hasMoreElements()) {
                        ...
                        if (category.equalsIgnoreCase("Shareware Games"))
                            dco.createReference(Software._Z_LICENSE, "Shareware");
                        else if (category.equalsIgnoreCase("Freeware Games"))
                            dco.createReference(Software._Z_LICENSE, "Freeware");
                        else
                            dco.createReference(Software._K_CATEGORIES, category);
                    }
                    ...
                    if (os != null) {
                        ...
                        dco.createReference(Software._H_PLATFORM, os);
                    }
