...
public abstract class ImdbSearch extends SearchTask {
    ...
    public ImdbSearch(IOnlineSearchClient listener, 
        ...
        if (region.getCode().equals("us"))
            ...
            tag = new String[] {"Durata:", "Voti degli utenti:", "Nazionalita:", "Divieti:", "Genere:", "Trivia:", "Lingua:", "Colore:", "Aspect Ratio:", "ancora"};
        else if (region.getCode().equals("de"))
            tag = new String[] {"Lange:", "Nutzer-Bewertung:", "Land:", "Altersfreigabe:", "Genre:", "Trivia:", "Sprache:", "Farbe:", "Seitenverhltnis:", "mehr"};
        else if (region.getCode().equals("fr"))
            tag = new String[] {"Duroe:", "Note des utilisateurs", "Pays:", "Classification:", "Genre:", "Trivia:", "Langue:", "Couleur:", "Rapport de forme:", "suite"};
        else if (region.getCode().equals("sp"))
            tag = new String[] {"Duracion:", "Calificacion:", "Pass:", "Clasificacion:", "Genero:", "Trivia:", "Idioma:", "Color:", "Relacin de Aspecto:", "ms"};
    }
